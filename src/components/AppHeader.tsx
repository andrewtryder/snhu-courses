        ...
        <header className="sticky top-0 z-20 border-b border-surface-variant bg-surface">
            <div className="mx-auto flex h-16 w-full max-w-[var(--spacing-container-max)] items-center gap-4 px-4 md:px-8">
                <div className="flex shrink-0 items-center gap-6">
                    <span className="font-[family-name:var(--font-headline)] text-xl font-bold text-primary">
                        SNHU
                    </span>
                    <nav className="hidden h-full items-center md:flex">
                        <span className="flex h-full items-center border-b-2 border-primary pb-1 text-sm font-semibold tracking-wide text-primary opacity-80">
